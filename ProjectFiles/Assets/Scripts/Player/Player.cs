namespace GorillaLocomotion
{
    ...
    public class Player : MonoBehaviour
    {
        ...
        public Transform InFrontCutSceneTransform;

        [Header("Light Powers Stuff")]
        public MeshRenderer LeftOuterSphere;
        public MeshRenderer LeftInnerSphere;
        public MeshRenderer RightOuterSphere;
        public MeshRenderer RightInnerSphere;
        public Light BodyLight;
        public Light LeftHandLight;
        public Light RightHandLight;
        public Light CurrentHeadLight;
        public GameObject CurrentHeadLightObject;
        public GameObject[] LightPowersIndex;
        public Color OuterLayerColor;
        public Color InnerLayerColor;

        [Header("Health System")]
        public bool CanGetDamage;
        public int Health = 100;
        public int MaxHealth = 100;
        public int HealIncreaseAmount = 2;
        public float HealTimerDefualtValue = 10;
        ...
        public GameObject A108ScreenEffect;
        public GameObject A176ScreenEffect;
        ...
        public void InitializeValues()
        {
            ...
            GodMode = false;
            OuterLayerColor = Color.yellow;
            InnerLayerColor = Color.yellow;
        }
        ...
        void Healing()
        {
            ...
            if (HealTimer < 0)
            {
                HealTimer = HealTimerDefualtValue;
                if (Health > MaxHealth)
                {
                    Health = MaxHealth;
                }
        ...
        public void DamagePlayer(int healthAmount)
        {
            if (CanGetDamage && !GodMode)
            {
                Health -= healthAmount;
                float RandomPitch = Random.Range(0.8f, 1.2f);
                PlayAudioAtPlayer(HurtSound, 0.4f, RandomPitch);
            }
        ...
        public void ChangeHandSpheresColor(Color OuterSphereColor, Color InnerSphereColor)
        {
            if (OuterSphereColor != null)
            {
                LeftOuterSphere.material.color = OuterSphereColor;
                RightOuterSphere.material.color = OuterSphereColor;
                OuterLayerColor = OuterSphereColor;
            }
            else
            {
                LeftOuterSphere.material.color = Color.yellow;
                RightOuterSphere.material.color = Color.yellow;
                OuterLayerColor = Color.yellow;
            }

            if (InnerSphereColor != null)
            {
                LeftInnerSphere.material.color = InnerSphereColor;
                RightInnerSphere.material.color = InnerSphereColor;
                InnerLayerColor = InnerSphereColor;
            }
            else
            {
                LeftInnerSphere.material.color = Color.yellow;
                RightInnerSphere.material.color = Color.yellow;
                InnerLayerColor = Color.yellow;
            }
        }

        #region Lights
        public void ChangeLightsColors(Color color)
        {
            BodyLight.color = color;
            LeftHandLight.color = color;
            RightHandLight.color = color;
        }

        public void DrainLightsIntensity(float drainAmount)
        {
            BodyLight.intensity -= drainAmount;
            LeftHandLight.intensity -= drainAmount;
            RightHandLight.intensity -= drainAmount;
            if (CurrentHeadLight != null)
            {
                CurrentHeadLight.intensity -= drainAmount;
            }
        }

        public void PowerOtherLightsIntensity(float addPowerAmount)
        {
            BodyLight.intensity += addPowerAmount;
            LeftHandLight.intensity += addPowerAmount;
            RightHandLight.intensity += addPowerAmount;
        }

        public void PowerHeadSpotLightIntensity(float addPowerAmount)
        {
            if (CurrentHeadLight != null)
            {
                CurrentHeadLight.intensity += addPowerAmount;
            }
        }
        ...
        {
            BodyLight.enabled = toggle;
            LeftHandLight.enabled = toggle;
            RightHandLight.enabled = toggle;
            if (CurrentHeadLightObject != null)
            {
                CurrentHeadLightObject.SetActive(toggle);
            }
            if (CurrentHeadLight != null)
            {
                CurrentHeadLight.enabled = toggle;
            }
        }

        public void SetCurrentHeadSpotLight(int HeadLightIndex)
        {
            LightPowersIndex[HeadLightIndex].SetActive(true);
            CurrentHeadLightObject = LightPowersIndex[HeadLightIndex];
            CurrentHeadLight = LightPowersIndex[HeadLightIndex].GetComponent<Light>();
        }

        public void DisableAllLightPowers()
        {
            foreach (var lightPowers in LightPowersIndex)
            {
                lightPowers.SetActive(false);
            }
        }
        #endregion
